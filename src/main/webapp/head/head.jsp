...
<%--                    <ul class="nav navbar-nav navbar-right">--%>
                    <ul class="nav navbar-nav admin_head_login">
                        <!----------------------------------- 未登录时显示 ----------------------------------->
...
<%--                        <li class="dropdown head_login col-md-2" style="display:none;">--%>
                        <li class="head_login" style="display:none;">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="height: 50px">
                                <img class="img-circle pull-left img-responsive nav-user-img" style="height: 25px" src="${APP_PATH }/static/img/head.png" alt="头像"/>
                                <span class="pull-left nav-username" style="margin-left: 6px">
